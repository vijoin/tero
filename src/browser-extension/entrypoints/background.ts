...
export default defineBackground(() => {
  ...
  browser.action.onClicked.addListener((tab) => toggleSidebar(tab.id!));
  ...
  browser.webRequest.onBeforeRequest.addListener(
    (req) => {processRequest(new RequestEvent(RequestEventType.OnBeforeRequest, req)); return undefined},
    { urls: ["http://*/*", "https://*/*"] },
    ["requestBody"]
  );
